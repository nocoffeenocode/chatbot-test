...
AZURE_SEARCH_SERVICE = os.environ.get("pocra-cognitive-search")
...
AZURE_OPENAI_RESOURCE = os.environ.get("Pocra-OpenAIServices")
AZURE_OPENAI_MODEL = os.environ.get("gpt-35-turbo")
AZURE_OPENAI_ENDPOINT = os.environ.get("https://pocra-ai.azurewebsites.net/")
AZURE_OPENAI_KEY = os.environ.get("b280b742acfc409fbd3e7634e1666e10")
...
AZURE_OPENAI_MODEL_NAME = os.environ.get("gpt-35-turbo") # Name of the model, e.g. 'gpt-35-turbo-16k' or 'gpt-4'
